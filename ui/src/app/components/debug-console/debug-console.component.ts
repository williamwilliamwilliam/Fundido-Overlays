...
@Component({
  ...
  styles: [`
    ...
    .log-time { color: var(--color-text-muted); min-width: 75px; }
    ...
    .level-debug .log-level { color: var(--color-log-debug); }
    .level-info .log-level { color: var(--color-log-info); }
    .level-warn .log-level { color: var(--color-log-warn); }
    .level-error .log-level { color: var(--color-log-error); }
